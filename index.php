...
function show_main($g_date="",$days="0"){
  ...
  for($i = 0 ; $i < 7 ; $i++){
    ...
    if(!empty($food[$i]["staple"]))$staple_YESNO = 1;
    if(!empty($food[$i]["dish1"]) || !empty($food[$i]["dish2"]) || !empty($food[$i]["dish3"]) || !empty($food[$i]["dish4"]) || !empty($food[$i]["dish5"])) $dish_YESNO = 1; 
    if(!empty($food[$i]["soup"]))$soup_YESNO = 1;
    if(!empty($food[$i]["fruit"]))$fruit_YESNO = 1;
    if(!empty($food[$i]["rem"])) $rem_YESNO = 1;
  }
